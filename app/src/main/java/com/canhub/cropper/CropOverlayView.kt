...
internal class CropOverlayView @JvmOverloads constructor(
  ...
  /** Currently moving pointer used to stop movement event when initial pointer was released (to avoid crop overlay jumps) */
  ...
  private val maxVerticalGestureExclusion =
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    mBorderCornerPaint =
      getNewPaintOrNull(mOptions?.borderCornerThickness ?: 0.0f, mOptions?.borderCornerColor ?: Color.WHITE)
   ...
   *  This can be prevented by setting systemGestureExclusionRects. However, Android lets you only exclude max
   *  200dp in total vertically.
